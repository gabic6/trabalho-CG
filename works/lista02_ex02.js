...
//conjunto 3
var s3 = createSphere();
c2.add(s3);//a esfera 3 tá agarrada no cilindro c2
...
function rotateCylinder()
{
  ...
  c1.matrix.multiply(mat4.makeRotationY(angle_y[0]));
...
function buildInterface()
{
  var controls = new function ()
  {
    ...
    this.rotate = function(){
      ...
      angle_y[0] = degreesToRadians(this.joint4);
