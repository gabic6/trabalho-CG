...
console.log("Num Predios:", posicoesXZPredios.length);
function criarCidade(){
    ...
    // Posiciona os predios
    for(var i=0; i<posicoesXZPredios.length; i++){
        var posPredio = posicoesXZPredios[i];
        var predioInd = Math.floor((listaPredios.length-1) * Math.random());
        var funcPredio = listaPredios[predioInd];
